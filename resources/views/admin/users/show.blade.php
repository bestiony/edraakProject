...
<div class="container flex bg-gray-50">
    {{-- left --}}
    <div class="m-8 items-center pt-4 flex flex-col p-3 w-1/4 rounded-l bg-white">
        <img
    ...
    {{-- right --}}
    <div class="m-8 items-center pt-4 flex flex-col p-3 w-3/5 rounded-l bg-white">
